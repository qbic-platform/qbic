/* src/config/qbic-config.h.  Generated from qbic-config.h.in by configure.  */
/* src/config/qbic-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "https://github.com/qbic-platform/qbic/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Qbic Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Qbic Core 0.12.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "qbiccore"
