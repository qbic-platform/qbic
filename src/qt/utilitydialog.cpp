    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Qbic Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Qbic Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  qbic-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Qbic in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
PrivateSend uses an qbictive process to mix your inputs with the inputs of two other people, without having your coins ever leave your wallet. \
...
These denominations are 0.01 QBIC, 0.1 QBIC, 1 QBIC and 10 QBIC -- sort of like the paper money you use every day.</li> \
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Qbic Core is shutting down...") + "<br /><br />" +
