    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Qbic Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Qbic address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and qbic: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Qbic Core"), this);
    aboutAction->setStatusTip(tr("Show information about Qbic Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Qbic Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Qbic addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Qbic addresses"));
    ...
    openAction->setStatusTip(tr("Open a qbic: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Qbic Core help message to get a list with possible Qbic Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Qbic Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Qbic network", "", count));
}
...
{
    QString strTitle = tr("Qbic Core"); // default title
