    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("QBIC-light"), QVariant("light"));
    ui->theme->addItem(QString("QBIC-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("QBIC-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("QBIC-traditional"), QVariant("trad"));
