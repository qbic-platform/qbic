 ...
 *
 *   // network
 *   CQbicNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.qbic.io/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CQbicNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: QbicNetwork
// //   -- signature requirements : Key1(User)
// class CQbicNetworkVariable : public CGovernanceObject
// {
// private:
