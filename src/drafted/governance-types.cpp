...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "QbicNetwork") type = QbicNetwork;
    if(strType == "QbicNetworkVariable") type = QbicNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == QbicNetwork) s = "QbicNetwork";
    if(type == QbicNetworkVariable) s = "QbicNetworkVariable";
