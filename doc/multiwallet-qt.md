...
Only requiring some minor changes is qbic.cpp.
...
Changes to qbic.cpp
----------------------
qbic.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
