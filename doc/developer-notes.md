...
Qbic Core is a multithreaded application, and deadlocks or other multithreading bugs
...
- ThreadSocketHandler : Sends/Receives data from peers on port 17195.
...
However, in open source software such as Qbic Core, where everyone uses
...
pay attention to for reviewers of Qbic Core code.
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Qbic Core uses tinyformat, which is type safe. Leave them out to avoid confusion
