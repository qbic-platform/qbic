...
This mechanism has been integrated into Bitcore-Node-Qbic which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/qbic-platform/insight-api-qbic#web-socket-api](https://github.com/qbic-platform/insight-api-qbic#web-socket-api) 
* API: [https://github.com/qbic-platform/insight-api-qbic#instantsend-transactions](https://github.com/qbic-platform/insight-api-qbic#instantsend-transactions) 
...
By default, the Qbic Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Qbic Core daemon:
